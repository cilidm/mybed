var Paging = /** @class */ (function () {
    ...
    Paging.prototype.createHtml = function () {
        ...
        var href = this.sitePath + "?page=";
        if (this.nowPage > 1){
            var prePage = this.sitePath + "?page=" + (this.nowPage -1);
        }else{
            var prePage = window.location.href;
        }
        if ((this.pageNum - this.nowPage) > 1){
            var nextHref = this.sitePath + "?page=" + (this.nowPage + 1);
        }else{
            var nextHref = window.location.href;
        }

        if(this.nowPage > 1){
            content.push("<li><a href='"+prePage+"'><span><i class=\"mdi mdi-chevron-left\"></i></span></a></li>");
        }else{
            content.push("<li class=\"disabled\"><a href='"+prePage+"'><span><i class=\"mdi mdi-chevron-left\"></i></span></a></li>");
        }
        //页面总数小于等于当前要展示页数总数，展示所有页面
        if (this.pageNum <= this.buttonNum) {
            for (var i = 1; i <= this.pageNum; i++) {
                if (this.nowPage !== i) {
                    content.push("<li><a href='"+href + i +"'>" + i + "</a></li>");
                }
                else {
                    content.push("<li class=\"active\"><a href='"+thisPath+"'>" + i + "</a></li>");
                }
            }
        }
            ...
            content.push("<li><a href='"+thisPath+"'>...</a></li>");
            content.push("<li><a href='"+href + this.pageNum+"'>" + this.pageNum + "</a></li>");
        }
        else if (this.pageNum - this.nowPage <= Math.floor(this.buttonNum / 2)) {
            //当前页面大于展示页数总数的一半（向下取整）
            content.push("<li><a href='"+href+"1'>" + 1 + "</a></li>");
            content.push("<li><a href='"+thisPath+"'>...</a></li>");
            ...
            if (this.nowPage - Math.floor(this.buttonNum / 2) <= 0) {
                ...
                content.push("<li><a href='"+href+"1'>" + 1 + "</a></li>");
                content.push("<li class='disabled'><a href='"+thisPath+"'>...</a></li>");
        ...
        content.push("<li><a href='"+nextHref+"'><span><i class=\"mdi mdi-chevron-right\"></i></span></a></li>");
        if (this.canJump) {
